 ...
 * @author anken
 */
public class CadLinguagem extends javax.swing.JFrame {

    /**
     * Creates new form CadLinguagem
     */
    public CadLinguagem() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTextFieldData.setText("Data Linguagem");

        jTextFieldNome.setText("Nome Linguagem");

        jTextFieldVersao.setText("Versão Linguagem");

        jTextFieldBib.setText("Bibliotecas Linguagem");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadLinguagem.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTextField jTextFieldBib;
